ВНИМАНИЕ ПРОЕКТ ЗАВЕРШИЛ ПОДДЕРЖКУ ВЫ МОЖЕТЕ ИСПОЛЬЗОВАТЬ ВСЕ НАРАБОТКИ В СВОИХ ПРОЕКТАХ ЛИБО ЗАЙДИТЕ В МОЙ ПРОФИЛЬ И ИСПОЛЬЗУЙТЕ БОТА ПЕРЕПИСАННОГО ПОД БИБЛИОТЕКУ YT_MONSTER_PY
